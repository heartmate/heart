                        ...
                        auth.createUserWithEmailAndPassword(p_email, p_password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Constant.Doctor.setDoctor_id(user.getUid());// from firebase to constant

                                    // get data from view to constant
                                    ...
                                    try {
                                        ...
                                        emailEditText.setError("error invalid email");
                                        emailEditText.requestFocus();
                                    } catch(FirebaseAuthUserCollisionException e) {
                                        emailEditText.setError("error user exists");
                                        emailEditText.requestFocus();
                                    } catch(Exception e) {
